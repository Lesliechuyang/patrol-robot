                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (client.call(srv))
                        {
                            ...
                            {
                                ROS_INFO("Service Result: successful!");
                                char result[10];
                                int n = sprintf(result, "%d", srv.response.success);
                                printf("srv.response.success = %s\n", result);
                                int ret = send(client_socket, result, n, 0);
                                if(ret > 0)
                                {
                            ...
                            {
                                ROS_INFO("Service Result: failed!");
                            }
                        }
                        else  
                        {
